...
const CallbackLanding = () => {
  ...
  const preselectedId = countryId || queryCountry || "";
  ...
  const selectedOption = useMemo(
    () => optionList.find((option) => option.id === form.interestId),
    [form.interestId]
  );
  const pageOption = selectedOption || matchedOption;
  const pageTitle = pageOption
  ...
  const submitCallback = async (event: FormEvent<HTMLFormElement>) => {
    ...
    const selected = optionList.find((option) => option.id === form.interestId);
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        <section className="relative overflow-hidden pt-44 sm:pt-48">
          <img
            src={matchedCountry?.image || heroImage}
          ...
          <div className="container relative z-10 mx-auto grid min-h-[76vh] gap-10 px-4 pb-16 pt-10 text-white lg:grid-cols-[1.05fr_0.8fr] lg:items-center">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 max-w-2xl text-base leading-8 text-white/85 sm:text-lg">
                Want to explore {destinationText} in more detail? Share your
                details and our counsellors will help you understand courses,
                admission chances, intake timing, documents, and the next step
                before you lose a good opening.
              </p>
            ...
            >
              ...
              <h2 className="mt-2 text-2xl font-bold">
                Claim your counselling call
              </h2>
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Tell us where you want to go. We will call you, then take you
                straight to the destination page so you can keep exploring.
              </p>
        ...
        <section className="bg-[#061226] py-12 text-white">
          <div className="container mx-auto flex flex-col gap-4 px-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link
              to="/countries"
              className="inline-flex items-center justify-center gap-2 rounded-md border border-yellow-300 bg-yellow-50 px-5 py-3 text-sm font-semibold text-slate-950 transition hover:bg-yellow-100"
            >
              Explore Countries
              <ArrowRight size={16} />
            </Link>
